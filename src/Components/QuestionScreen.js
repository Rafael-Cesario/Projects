    ...
    <div className="container">
      ...
      <form onSubmit={(e) => next(e)} className="form-answer">
        <input
          ...
          onChange={(e) => setInputAnswerValue(e.target.value)}
      ...
      <p className="remain-words">
        {study.toStudy.length + study.studying.length} Palavras até terminar a
        lista{" "}
      </p>
    </div>
  );
