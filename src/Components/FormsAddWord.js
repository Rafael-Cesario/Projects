...
const FormsAddWord = ({
  ...
  const WordAlreadExist = () => {
    ...
    const duplicatedTerm =
      termosUpper.indexOf(singleTerm.toUpperCase()) > -1 ? true : false;
    ...
    <div className="forms-add-word">
      ...
      <form className="several">
        ...
        <textarea
          ...
          onChange={(e) => setSeveralWords(e.target.value)}
        />
      ...
      <form className="single" onSubmit={(e) => addSingleWord(e)}>
        ...
        <div className="input-group">
          ...
          <input
            type="text"
            value={singleDefinition}
            onChange={(e) => setSingleDefinition(e.target.value)}
            ref={inputWord02}
          />
        </div>
